...
<div id="fake-article">
	<div class="inner">
		<div class="header">
			<div class="logo">
				<img src="/images/BH-hubquire.svg" alt="">
			</div>
		</div>
		<div class="nav">
			<div class="inner">
		...
		<div class="content">
			...
			<div class="side">
				...
				<div class="fake-social">
					<div class="icon-facebook"><span>share</span></div>
					<div class="icon-twitter"><span>tweet</span></div>
					<div class="icon-pinterest"><span>pin</span></div>
				</div>
			</div>
